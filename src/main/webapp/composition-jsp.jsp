...
<div class="row">
    ...
    <div class="container">
        ...
        <div class="container text-left">
            ...
            <a href="<%=request.getContextPath()%>/compositionaddform" class="btn btn-success">Add
                New Composition</a>
        </div>
        <br>
        <table class="table table-bordered">
            ...
            <c:forEach var="composition" items="${compositions}">
                ...
                <tr>
                    ...
                    <td><a href="compositionaddform?id=<c:out value='${composition.getId()}' />">Edit</a>
                        &nbsp;&nbsp;&nbsp;&nbsp; <a
                                href="deletecomposition?id=<c:out value='${composition.getId()}' />">Delete</a></td>
                </tr>
            </c:forEach>
            <!-- } -->
            </tbody>
